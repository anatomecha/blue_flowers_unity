...
//Name: octahedron_children.ma
//Last modified: Fri, May 01, 2015 11:52:08 AM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.0999380383425006 1.4379501561664612 1.5262155551789371 ;
	setAttr ".r" -type "double3" -20.738352729598212 -69.799999999998121 4.6055187815745492e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 4.6858803612888167;
...
createNode transform -n "pSolid2" -p "axiom_transform";
	setAttr ".t" -type "double3" 0 0.6 1.33226763e-016 ;
...
createNode mesh -n "pSolidShape2" -p "pSolid2";
	...
	setAttr -s 24 ".uvst[0].uvsp[0:23]" -type "float2" 0.49999997 1 2.9802322e-008
		 -2.1855694e-008 1 5.1658017e-008 0.49999997 1 2.9802322e-008 -2.1855694e-008 1 5.1658017e-008
		 0 0 1 0 0.5 1 0.49999997 1 2.9802322e-008 -2.1855694e-008 1 5.1658017e-008 0 0 1
		 0 0.5 1 0 0 1 0 0.5 1 0 0 1 0 0.5 1 0 0 1 0 0.5 1;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 6 ".vt[0:5]"  0 1 2.220446e-016 1 0 0 0 2.220446e-016 -1
		 -1 0 0 0 -2.220446e-016 1 0 -1 -2.220446e-016;
	setAttr -s 12 ".ed[0:11]"  1 2 0 2 0 0 0 1 0 2 3 0 3 0 0 3 4 0 4 0 0
		 4 1 0 5 2 0 1 5 0 5 3 0 5 4 0;
...
createNode transform -n "pSolid3" -p "axiom_transform";
	setAttr ".t" -type "double3" -0.59999999999084608 8.2032158843503566e-012 -4.7216328069588087e-012 ;
	setAttr ".s" -type "double3" 0.4 0.4 0.4 ;
...
createNode transform -n "pSolid4" -p "axiom_transform";
	setAttr ".t" -type "double3" 3.4547975591436852e-011 -9.7998553716394099e-012 -0.60000000003977982 ;
	setAttr ".s" -type "double3" 0.4 0.4 0.4 ;
...
createNode transform -n "pSolid5" -p "axiom_transform";
	setAttr ".t" -type "double3" -2.9368119047745722e-011 -0.59999999995436282 -9.7376551266847855e-012 ;
	setAttr ".s" -type "double3" 0.4 0.4 0.4 ;
...
createNode transform -n "pSolid6" -p "axiom_transform";
	setAttr ".t" -type "double3" 1.1330936189324348e-011 1.0557027474433767e-011 0.60000000003088161 ;
	setAttr ".s" -type "double3" 0.4 0.4 0.4 ;
...
createNode transform -n "pSolid7" -p "axiom_transform";
	setAttr ".t" -type "double3" 0.59999999999349107 -1.0721395993229521e-011 -1.1215445239187716e-011 ;
	setAttr ".s" -type "double3" 0.4 0.4 0.4 ;
